/**
 * Generate Qi volume catalog config from epub structure.
 * Run: node scripts/generate-qi-config.mjs
 * Output: scripts/qi-config.mjs
 */
import fs from "fs";
...
const OUTPUT_PATH = path.join(__dirname, "qi-config.mjs");
const DEFAULT_EPUB = "/Users/lima/Desktop/古诗源.epub";

const EPUB_PARTS = ["text/part0018_split_000.html"];
