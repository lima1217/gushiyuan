/**
 * Generate Jin volume catalog config from epub structure.
 * Run: node scripts/generate-jin-config.mjs
 * Output: scripts/jin-config.mjs
 */
import fs from "fs";
...
const OUTPUT_PATH = path.join(__dirname, "jin-config.mjs");
