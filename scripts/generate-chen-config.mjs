/**
 * Generate Chen volume catalog config from epub structure.
 * Run: node scripts/generate-chen-config.mjs
 * Output: scripts/chen-config.mjs
 */
import fs from "fs";
...
const OUTPUT_PATH = path.join(__dirname, "chen-config.mjs");
const DEFAULT_EPUB = "/Users/lima/Desktop/古诗源.epub";

const EPUB_PARTS = ["text/part0020_split_000.html"];
