/**
 * Generate Song volume catalog config from epub structure.
 * Run: node scripts/generate-song-config.mjs
 * Output: scripts/song-config.mjs
 */
import fs from "fs";
...
const OUTPUT_PATH = path.join(__dirname, "song-config.mjs");
const DEFAULT_EPUB = "/Users/lima/Desktop/古诗源.epub";

const EPUB_PARTS = ["text/part0016.html", "text/part0017.html"];
