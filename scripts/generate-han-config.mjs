/**
 * Generate Han volume catalog config from epub structure.
 * Run: node scripts/generate-han-config.mjs
 * Output: scripts/han-config.mjs
 */
import fs from "fs";
...
const OUTPUT_PATH = path.join(__dirname, "han-config.mjs");
