/**
 * Generate Liang volume catalog config from epub structure.
 * Run: node scripts/generate-liang-config.mjs
 * Output: scripts/liang-config.mjs
 */
import fs from "fs";
...
const OUTPUT_PATH = path.join(__dirname, "liang-config.mjs");
